...
sFilename_domain_in= '/compyfs/liao313/04model/e3sm/sag/cases_aux/e3sm20230501001/mosart_sag_domain.nc'
sFilename_parameter_in='/compyfs/liao313/04model/e3sm/sag/cases_aux/e3sm20230501001/mosart_sag_parameter.nc'
sFilename_geojson_out='/compyfs/liao313/04model/e3sm/sag/cases_aux/e3sm20230501001/mosart_sag_parameter.geojson'
...
mosart_map_unstructured_parameters(sFilename_domain_in, sFilename_parameter_in, sFilename_geojson_out, 
                                   aVariable_parameter, aVariable_short,
                                    aFlag_scientific_notation_colorbar_in= aFlag_scientific_notation_colorbar,
                                      iSize_x_in=6, iSize_y_in=8)
sFilename_geojson_out='/compyfs/liao313/04model/e3sm/sag/cases_aux/e3sm20230501001/mosart_sag_flow_direction.geojson'
