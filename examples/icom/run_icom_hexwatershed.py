...
#sFilename_json_in='/compyfs/liao313/04model/pyhexwatershed/icom/pyhexwatershed20220607001/hexwatershed/hexwatershed.json'

sFilename_mpas_in='/people/liao313/workspace/python/pyhexwatershed_icom/data/icom/input/lnd_cull_mesh.nc'
sFilename_mosart_parameter_in = '/compyfs/inputdata/rof/mosart/MOSART_Global_half_20210616.nc'

#this one should be replace 
sFilename_e3sm_configuration = '/qfs/people/liao313/workspace/python/liao-etal_2023_mosart_joh/examples/icom/e3sm.xml'
...
sFilename_mosart_parameter_out = sWorkspace_output + '/mosart_icom_parameter_mpas.nc'
sFilename_mosart_unstructured_domain= sWorkspace_output + '/mosart_icom_domain_mpas.nc'
sFilename_mosart_unstructured_script = sWorkspace_output + '/mosart_icom_scriptgrid_mpas.nc'

sFilename_elm_structured_domain_file_out_1d = sWorkspace_output + '/elm_icom_domain_latlon.nc'
sFilename_elm_structured_script_1d = sWorkspace_output + '/elm_icom_scripgrid_latlon.nc'

sFilename_map_elm_to_mosart = sWorkspace_output + '/l2r_icom_mapping.nc'
sFilename_map_mosart_to_elm = sWorkspace_output + '/r2l_icom_mapping.nc'
