...
sFilename_remap = '/compyfs/liao313/04model/e3sm/susquehanna/cases_aux/e3sm20230401006/mosart_susquehanna_domain.nc'

mosart_save_variable_unstructured( oCase, sVariable_in = sVariable, iFlag_remap_in=1, sFilename_domain_file_in = sFilename_remap)
