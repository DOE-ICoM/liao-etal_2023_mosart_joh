...
sFilename = '/compyfs/liao313/04model/e3sm/susquehanna/cases_aux/e3sm20230329001/mosart_susquehanna_parameter_rwid.png'
image_dummy = Image.open(sFilename)
aImage.append(image_dummy)

sFilename = '/compyfs/liao313/04model/e3sm/susquehanna/cases_aux/e3sm20240102001/mosart_susquehanna_parameter_rwid.png'
image_dummy = Image.open(sFilename)
aImage.append(image_dummy)
...
sFilename_out = '/qfs/people/liao313/workspace/python/liao-etal_2023_mosart_joh/codes/susquehanna/comparison/river_width_comparison.png'
#plt.show()
