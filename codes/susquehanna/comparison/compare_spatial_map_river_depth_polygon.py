...
sFilename_base='/compyfs/liao313/04model/e3sm/susquehanna/analysis/e3sm20240101002/main_channel_water_depth_liq/geojson/201905.geojson'
sFilename_new ='/compyfs/liao313/04model/e3sm/susquehanna/analysis/e3sm20240102001/main_channel_water_depth_liq/geojson/201905.geojson'
sAttribute_name_base='main'
sAttribute_name_new='main'
sFilename_diff='/qfs/people/liao313/workspace/python/liao-etal_2023_mosart_joh/codes/susquehanna/comparison/river_depth_difference.geojson'

#polygon_difference_cython(sFilename_base, sFilename_new, sAttribute_name_base, sAttribute_name_new, sFilename_diff)
sFilename_domain_base = '/compyfs/liao313/04model/e3sm/susquehanna/cases_aux/e3sm20240101002/mosart_susquehanna_parameter.nc'
sFilename_domain_new ='/compyfs/liao313/04model/e3sm/susquehanna/cases_aux/e3sm20240102001/mosart_susquehanna_parameter.nc'
...
if iFlag_percent == 1:
    ...
    sColormap = 'RdBu'
    sExtend = 'both'
    sFilename_output_png = '/qfs/people/liao313/workspace/python/liao-etal_2023_mosart_joh/codes/susquehanna/comparison/river_depth_difference_percent.png'
else:
    sVar = 'diff'
    aData_diff = retrieve_field_value(sFilename_diff, sVar)
    ...
    sColormap = 'RdBu'
    sExtend = 'both'
    sFilename_output_png = '/qfs/people/liao313/workspace/python/liao-etal_2023_mosart_joh/codes/susquehanna/comparison/river_depth_difference.png'
