...
sFilename = '/compyfs/liao313/04model/e3sm/susquehanna/cases_aux/e3sm20230329001/mosart_susquehanna_flow_direction.png'
image_dummy = Image.open(sFilename)
aImage.append(image_dummy)

sFilename = '/compyfs/liao313/04model/e3sm/susquehanna/cases_aux/e3sm20230401002/mosart_susquehanna_flow_direction.png'
image_dummy = Image.open(sFilename)
aImage.append(image_dummy)

# Create a figure and subplots

fig, axs = plt.subplots( 1,ncolumn+1, figsize=(16, 7), gridspec_kw={'width_ratios': [4,4,1]},dpi=300)
...
fig.suptitle("Flow direction", fontsize=16,  y=0.98)
# Adjust layout
#add an additional colorbar

dValue_min=0
dValue_max= 7.0E4 # 6.0E12
sColormap = 'Spectral_r'
sExtend =  'max'
sUnit= r'Drainage area (units: $km^{2}$)'
...
sFilename_out = '/qfs/people/liao313/workspace/python/liao-etal_2023_mosart_joh/codes/susquehanna/comparison/flow_direction_comparison.png'
#plt.show()
