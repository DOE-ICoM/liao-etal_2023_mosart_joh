...
CASE_NAME=Susquehanna_Square_8th_${GIT_HASH}_test_dev.`date "+%Y-%m-%d-%H%M%S"`
​
...
./xmlchange LND_DOMAIN_FILE=domain_lnd_susquehanna_8th_c200922.nc
./xmlchange ATM_DOMAIN_FILE=domain_lnd_susquehanna_8th_c200922.nc
./xmlchange LND_DOMAIN_PATH=/compyfs/icom/xudo627/latlon
./xmlchange ATM_DOMAIN_PATH=/compyfs/icom/xudo627/latlon
​
...
frivinp_rtm = '/compyfs/icom/xudo627/latlon/MOSART_susquehanna_8th_c200922.nc'
#routingmethod = 2
EOF
​
