...
sFilename = '/compyfs/liao313/04model/e3sm/amazon/cases_aux/e3sm20230501001/mosart_amazon_flow_direction.png'
image_dummy = Image.open(sFilename)
aImage.append(image_dummy)

sFilename = '/compyfs/liao313/04model/e3sm/amazon/cases_aux/e3sm20240102007/mosart_amazon_flow_direction.png'
image_dummy = Image.open(sFilename)
aImage.append(image_dummy)

# Create a figure and subplots

fig, axs = plt.subplots( 1,ncolumn+1, figsize=(16, 6), gridspec_kw={'width_ratios': [4,4,1]},dpi=300)
...
dValue_min=0
dValue_max= 6.0E6 # 6.0E12 dData_max = 6.0E6 #* 1.0E6
...
sFilename_out = '/qfs/people/liao313/workspace/python/liao-etal_2023_mosart_joh/codes/amazon/comparison/flow_direction_comparison.png'
#plt.show()
