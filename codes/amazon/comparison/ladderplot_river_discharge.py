...
sFilename_domain_geojson = '/compyfs/liao313/04model/e3sm/amazon/cases_aux/e3sm20240501004/mosart_amazon_parameter_mesh.geojson'
...
#find which cell contains the site
sFilename_domain_geojson = '/compyfs/liao313/04model/e3sm/amazon/cases_aux/e3sm20240102007/mosart_amazon_parameter_mesh.geojson'
pDriver = ogr.GetDriverByName('GeoJSON')
pDataset = pDriver.Open(sFilename_domain_geojson, gdal.GA_ReadOnly)
pLayer = pDataset.GetLayer(0)
pSrs = osr.SpatialReference()
...
#save the all the points to a geojson polyline file
sFilename_out = '/qfs/people/liao313/workspace/python/liao-etal_2023_mosart_joh/figures/amazon/ladder.geojson'
pDriver = ogr.GetDriverByName('GeoJSON')
...
aLinestyle = ['-', '--']
aLinewidth = np.full(2,mpl.rcParams['lines.linewidth'])

aLabel_legend=['DRT mesh-based', 'MPAS mesh-based']

sFormat_x =  '%.1E'
sFormat_y =  '%.1E'
sLabel_x = 'Distance to outlet (m)'
sLabel_y = r'River discharge $(m^{3}/s)$'
sFilename_out = '/qfs/people/liao313/workspace/python/liao-etal_2023_mosart_joh/figures/amazon/ladderplot_river_discharge.png'
ladder_plot_xy_data(aX_all,  aY_all,
        sFilename_out,
        aY_all_twin_in=aY_all_twin_in, iFlag_twiny_in=1,aLabel_legend_twin_in=['DRT mesh-based water depth', 'MPAS mesh-based water depth'],dMax_y_twin_in=30.0,
        iDPI_in = None, aFlag_trend_in = None,
            iReverse_y_in = None,  iSize_x_in = None,
                ...
                iSize_y_in = None,  ncolumn_in = None,
                    ...
                    dMax_y_in =3.1E5, dMin_y_in = None,
                        dSpace_y_in = None,
