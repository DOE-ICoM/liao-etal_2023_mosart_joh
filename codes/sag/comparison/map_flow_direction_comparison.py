...
sFilename = '/compyfs/liao313/04model/e3sm/sag/cases_aux/e3sm20230101001/mosart_sag_flow_direction.png'
image_dummy = Image.open(sFilename)
aImage.append(image_dummy)

sFilename = '/compyfs/liao313/04model/e3sm/sag/cases_aux/e3sm20240103001/mosart_sag_flow_direction.png'
image_dummy = Image.open(sFilename)
aImage.append(image_dummy)
...
sFilename_out = '/qfs/people/liao313/workspace/python/liao-etal_2023_mosart_joh/codes/sag/comparison/flow_direction_comparison.png'
#plt.show()
