...
sFilename_domain_in= '/compyfs/liao313/04model/e3sm/columbia/cases_aux/e3sm20230501001/mosart_columbia_domain.nc'
sFilename_parameter_in='/compyfs/liao313/04model/e3sm/columbia/cases_aux/e3sm20230501001/mosart_columbia_parameter.nc'
sFilename_geojson_out='/compyfs/liao313/04model/e3sm/columbia/cases_aux/e3sm20230501001/mosart_columbia_parameter.geojson'
...
sFilename_geojson_out='/compyfs/liao313/04model/e3sm/columbia/cases_aux/e3sm20230501001/mosart_columbia_flow_direction.geojson'
mosart_map_unstructured_flow_direction(sFilename_domain_in, sFilename_parameter_in, sFilename_geojson_out, iSize_x_in=8, iSize_y_in=8)
