...
CASE_NAME=Susquehanna_MPAS_Test_${GIT_HASH}.`date "+%Y-%m-%d-%H%M%S"`
​
...
./xmlchange LND_DOMAIN_FILE=domain_lnd_Susquehanna_MPAS_c211018.nc
./xmlchange ATM_DOMAIN_FILE=domain_lnd_Susquehanna_MPAS_c211018.nc
./xmlchange LND_DOMAIN_PATH=/compyfs/xudo627/Susquehanna_test
./xmlchange ATM_DOMAIN_PATH=/compyfs/xudo627/Susquehanna_test
​
...
frivinp_rtm = '/compyfs/xudo627/Susquehanna_test/MOSART_Susquehanna_MPAS_c211018.nc'
routingmethod = 1
inundflag = .true.
opt_elevprof = 1
EOF
